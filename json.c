...
static ErrorUnion_z_json_JsonValue z_json_parseBoolean(struct z_json_Parser* p) {
    if (p->input.len - p->pos >= 4 && p->input.ptr[p->pos] == 't' && p->input.ptr[p->pos + 1] == 'r' && p->input.ptr[p->pos + 2] == 'u' && p->input.ptr[p->pos + 3] == 'e') {
        struct z_json_JsonValue z_json_val_true;
        p->pos += 4;
        z_json_val_true.tag = z_json_JsonValueTag_Boolean;
        z_json_val_true.data.boolean = 1;
        {
            ErrorUnion_z_json_JsonValue __return_val;
            __return_val.data.payload = z_json_val_true;
            __return_val.is_error = 0;
            return __return_val;
        }
    }
    if (p->input.len - p->pos >= 5 && p->input.ptr[p->pos] == 'f' && p->input.ptr[p->pos + 1] == 'a' && p->input.ptr[p->pos + 2] == 'l' && p->input.ptr[p->pos + 3] == 's' && p->input.ptr[p->pos + 4] == 'e') {
        struct z_json_JsonValue z_json_val_false;
        p->pos += 5;
        z_json_val_false.tag = z_json_JsonValueTag_Boolean;
        z_json_val_false.data.boolean = 0;
        {
            ErrorUnion_z_json_JsonValue __return_val;
            __return_val.data.payload = z_json_val_false;
            __return_val.is_error = 0;
            return __return_val;
        }
    }
...
static double z_json_parseFloat(Slice_u8 s) {
    ...
    usize z_json_one;
    Optional_Ptr_c_char z_json_endptr_null;
