...
static RETR_UNUSED_FUNC i32 __bootstrap_i32_from_u32(u32 x) {
    if (x > 2147483647U) __bootstrap_panic("integer overflow in @intCast", __FILE__, __LINE__);
    return (i32)x;
}

static RETR_UNUSED_FUNC u32 __bootstrap_u32_from_u64(u64 x) {
    if (x > (u64)4294967295U) __bootstrap_panic("integer overflow in @intCast", __FILE__, __LINE__);
    return (u32)x;
}

static RETR_UNUSED_FUNC u32 __bootstrap_u32_from_i32(i32 x) {
    if (x < 0) __bootstrap_panic("integer overflow in @intCast", __FILE__, __LINE__);
    return (u32)x;
}

static RETR_UNUSED_FUNC usize __bootstrap_usize_from_i32(i32 x) {
    if (x < 0) __bootstrap_panic("integer overflow in @intCast", __FILE__, __LINE__);
    return (usize)x;
}

static RETR_UNUSED_FUNC i32 __bootstrap_i32_from_usize(usize x) {
    if (x > 2147483647U) __bootstrap_panic("integer overflow in @intCast", __FILE__, __LINE__);
    return (i32)x;
}

static RETR_UNUSED_FUNC u8 __bootstrap_u8_from_bool(bool b) {
    return (u8)b;
}

static RETR_UNUSED_FUNC f32 __bootstrap_f32_from_f64(double x) {
    return (f32)x;
}

static RETR_UNUSED_FUNC i32 __bootstrap_i32_from_u8(u8 x) {
    return (i32)x;
}

static RETR_UNUSED_FUNC u8 __bootstrap_u8_from_i32(i32 x) {
    if (x < 0 || x > 255) __bootstrap_panic("integer cast overflow", __FILE__, __LINE__);
    return (u8)x;
}

static RETR_UNUSED_FUNC u16 __bootstrap_u16_from_i32(i32 x) {
    if (x < 0 || x > 65535) __bootstrap_panic("integer cast overflow", __FILE__, __LINE__);
    return (u16)x;
}

static RETR_UNUSED_FUNC u32 __bootstrap_u32_from_i64(i64 x) {
    if (x < 0 || x > (i64)4294967295U) __bootstrap_panic("integer cast overflow", __FILE__, __LINE__);
    return (u32)x;
}

static RETR_UNUSED_FUNC i8 __bootstrap_i8_from_i32(i32 x) {
    if (x < -128 || x > 127) __bootstrap_panic("integer cast overflow", __FILE__, __LINE__);
    return (i8)x;
}

static RETR_UNUSED_FUNC i16 __bootstrap_i16_from_i32(i32 x) {
    if (x < -32768 || x > 32767) __bootstrap_panic("integer cast overflow", __FILE__, __LINE__);
    return (i16)x;
}

static RETR_UNUSED_FUNC i32 __bootstrap_i32_from_i64(i64 x) {
