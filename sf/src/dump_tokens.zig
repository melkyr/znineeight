...
fn tokenKindToString(kind: TokenKind, buf: []u8) []u8 {
    ...
    switch (kind) {
        ...
        TokenKind.plus_pct => { var s: []const u8 = "plus_pct"; fmt.copyStr(buf, &idx, s); },
        TokenKind.minus_pct => { var s: []const u8 = "minus_pct"; fmt.copyStr(buf, &idx, s); },
        TokenKind.star_pct => { var s: []const u8 = "star_pct"; fmt.copyStr(buf, &idx, s); },
        TokenKind.plus_pct_eq => { var s: []const u8 = "plus_pct_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.minus_pct_eq => { var s: []const u8 = "minus_pct_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.star_pct_eq => { var s: []const u8 = "star_pct_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.plus_pipe => { var s: []const u8 = "plus_pipe"; fmt.copyStr(buf, &idx, s); },
        TokenKind.minus_pipe => { var s: []const u8 = "minus_pipe"; fmt.copyStr(buf, &idx, s); },
        TokenKind.star_pipe => { var s: []const u8 = "star_pipe"; fmt.copyStr(buf, &idx, s); },
        TokenKind.shl_pipe => { var s: []const u8 = "shl_pipe"; fmt.copyStr(buf, &idx, s); },
        TokenKind.plus_pipe_eq => { var s: []const u8 = "plus_pipe_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.minus_pipe_eq => { var s: []const u8 = "minus_pipe_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.star_pipe_eq => { var s: []const u8 = "star_pipe_eq"; fmt.copyStr(buf, &idx, s); },
        TokenKind.shl_pipe_eq => { var s: []const u8 = "shl_pipe_eq"; fmt.copyStr(buf, &idx, s); },
