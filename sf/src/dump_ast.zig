...
fn astKindToString(kind: AstKind, buf: []u8) []u8 {
    ...
    switch (kind) {
        ...
        AstKind.grouped_expr => { var s: []const u8 = "grouped_expr"; dh.copyStr(buf, &idx, s); },
        ...
        AstKind.labeled_block_expr => { var s: []const u8 = "labeled_block_expr"; dh.copyStr(buf, &idx, s); },
        ...
        AstKind.assign_expr => { var s: []const u8 = "assign_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.add_expr => { var s: []const u8 = "add_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.sub_expr => { var s: []const u8 = "sub_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.mul_expr => { var s: []const u8 = "mul_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.div_expr => { var s: []const u8 = "div_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.mod_expr => { var s: []const u8 = "mod_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.bit_and_expr => { var s: []const u8 = "bit_and_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.bit_or_expr => { var s: []const u8 = "bit_or_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.bit_xor_expr => { var s: []const u8 = "bit_xor_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.shl_expr => { var s: []const u8 = "shl_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.shr_expr => { var s: []const u8 = "shr_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.logic_and_expr => { var s: []const u8 = "logic_and_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.logic_or_expr => { var s: []const u8 = "logic_or_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.eq_expr => { var s: []const u8 = "eq_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.neq_expr => { var s: []const u8 = "neq_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.less_expr => { var s: []const u8 = "less_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.less_eq_expr => { var s: []const u8 = "less_eq_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.greater_expr => { var s: []const u8 = "greater_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.greater_eq_expr => { var s: []const u8 = "greater_eq_expr"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_add => { var s: []const u8 = "compound_add"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_sub => { var s: []const u8 = "compound_sub"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_mul => { var s: []const u8 = "compound_mul"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_div => { var s: []const u8 = "compound_div"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_mod => { var s: []const u8 = "compound_mod"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_bit_and => { var s: []const u8 = "compound_bit_and"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_bit_or => { var s: []const u8 = "compound_bit_or"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_bit_xor => { var s: []const u8 = "compound_bit_xor"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_shl => { var s: []const u8 = "compound_shl"; dh.copyStr(buf, &idx, s); },
        AstKind.compound_shr => { var s: []const u8 = "compound_shr"; dh.copyStr(buf, &idx, s); },
