...
pub fn bufferedWriterInit() BufferedWriter {
    return BufferedWriter{ .buf = undefined, .pos = @intCast(usize, 0), .fd = @intCast(i32, 1) };
}

pub fn bufferedWriterInitFd(fd: i32) BufferedWriter {
