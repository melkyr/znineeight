...
| `emitPointeeDep` | c89_emit.zig (Task 6: recursive pointee typedef deps through ptr chains/optional/slice/array/eu) |
...
| `emitPtrValuePrint` | c89_emit.zig (Task 6: pointer `{}` dispatch — delegation / inline `T@hex`) |
...
| `zigPrintNameAppend` | c89_emit.zig (Task 6: Zig `@typeName` renderer for pointer children) |
| `printFmtPointeeNameOk` | lower.zig (Task 6: mirrored name-space predicate) |
