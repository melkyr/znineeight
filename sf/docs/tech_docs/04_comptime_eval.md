...
12. **Task 4 review-round residuals (documented; out of Task 5 scope).** (a) A module-scope
    ANNOTATED const with an out-of-range literal (`const W: i8 = 200;`) keeps the pre-existing
    warning[3000]+truncate declaration path and can emit gcc-invalid C; the UNANNOTATED module
