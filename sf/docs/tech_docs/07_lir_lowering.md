...
| `lowerInitOrderVisit` | `(self, i, decls, names, n, emitted, visiting, order, order_len, dep_buf, cycle)` | Depth-first stable dependency order for one module's globals; detects a same-module cycle (`error[3064]`) |
