...
#     -o <out>/zig1_5_clean
#   std lib: 12 std .zig copied into <out>/lib/
...
cp "$ROOT"/sf/src/std.zig "$ROOT"/sf/src/std_io.zig "$ROOT"/sf/src/std_arena.zig "$ROOT"/sf/src/std_net.zig "$ROOT"/sf/src/std_str.zig "$ROOT"/sf/src/std_mem.zig "$ROOT"/sf/src/std_math.zig "$ROOT"/sf/src/std_debug.zig "$ROOT"/sf/src/std_async.zig "$ROOT"/sf/src/std_bits.zig "$ROOT"/sf/src/std_os.zig "$ROOT"/sf/src/std_os_pal.zig "$OUT/lib/"
