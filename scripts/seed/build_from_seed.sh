...
cp "$ROOT"/sf/src/std.zig "$ROOT"/sf/src/std_io.zig "$ROOT"/sf/src/std_arena.zig "$ROOT"/sf/src/std_net.zig "$ROOT"/sf/src/std_str.zig "$ROOT"/sf/src/std_mem.zig "$ROOT"/sf/src/std_math.zig "$ROOT"/sf/src/std_debug.zig "$ROOT"/sf/src/std_async.zig "$ROOT"/sf/src/std_bits.zig "$ROOT"/sf/src/std_os.zig "$ROOT"/sf/src/std_os_pal.zig "$ROOT"/sf/src/std_time.zig "$ROOT"/sf/src/std_time_pal.zig "$ROOT"/sf/src/std_buf.zig "$ROOT"/sf/src/std_file.zig "$ROOT"/sf/src/std_file_pal.zig "$ROOT"/sf/src/std_stdin.zig "$ROOT"/sf/src/std_stdin_pal.zig "$ROOT"/sf/src/std_stream.zig "$ROOT"/sf/src/std_crypto.zig "$ROOT"/sf/src/std_parse.zig "$ROOT"/sf/src/std_map.zig "$OUT/lib/"
