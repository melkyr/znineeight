...
- **Double-Free Detection**: Enhanced `DoubleFreeAnalyzer` with composite name tracking (e.g., `s.ptr`) and improved loop merging for aggregate types and error unions.
