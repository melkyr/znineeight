...
This document summarizes the specific constraints and strategies used in the Z98 compiler to ensure compatibility with Microsoft Visual C++ 6.0 and the C++98 standard.
