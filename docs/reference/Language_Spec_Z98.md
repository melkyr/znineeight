...
- **Unions**:
    ...
    - **Tagged Unions**: `const U = union(enum) { field: T, ... };`. Automatically managed tag and payload. Tagged unions are lowered to C `struct`s containing a tag and a data union.
