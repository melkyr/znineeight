...
- **Float comparisons** do not fold — **pending Part II Task 9** of `docs/superpowers/plans/2026-09-22-z98-comptime-int-parity-plan.md`. Float arithmetic precision remains a non-goal (§5).
