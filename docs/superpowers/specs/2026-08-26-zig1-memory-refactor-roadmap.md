...
| 1/2/5 live compaction | lowers the pool floor | pool ≥ live total, so shrinking live (3.1–3.5 MB combined; I-1) directly lowers the committed floor; alone it still leaves live ≈16.5–17 MiB (I-4 f#1) |
