...
Current seed is **seed v51** (archive md5 `55694207eaf1f29a98400eb7364bb5d9`; v51 rotation — Task 11N: lower `.len` on a struct-field array; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `5dd7874d…` → `6cbb52440c2e91e33f735e4e09368fd5` (two-hop closure hop1==hop2)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`6cbb52440c2e91e33f735e4e09368fd5`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v51 archive
