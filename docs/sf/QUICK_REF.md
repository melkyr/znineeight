...
Current seed is **seed v50** (archive md5 `a9f303cac8f3710fa51ea475b51bfec9`; v50 rotation — Task 11L: make `bool` 1 byte/align 1 to match Zig; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `9b292edf…` → `5dd7874d7a69e015f63874abc30b3222` (moving point, hop2==hop3)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`5dd7874d7a69e015f63874abc30b3222`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v50 archive
