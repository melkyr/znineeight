...
Current seed is **seed v44** (archive md5 `d5bcddd4fd513a2ca3fe2c0997dee9ec`; v44 rotation — Task 11B `@floatCast` lowering fix; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `1c4f6765…` → `27e61065a8006183d5f8c55043890c7c`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`27e61065a8006183d5f8c55043890c7c`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v44 archive
...
`repro/mi_matrix/EXPECTED_FAIL.md` v164.
The archived binary and the self-emission fixed point
`27e61065a8006183d5f8c55043890c7c` are the SAME compiler state (the v44
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `27e61065a8006183d5f8c55043890c7c` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=27e61065a8006183d5f8c55043890c7c` to gate on it explicitly.
...
Binary md5 MUST equal `27e61065a8006183d5f8c55043890c7c`.
