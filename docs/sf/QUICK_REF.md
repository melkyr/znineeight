...
Current seed is **seed v20** (archive md5 `f2175ae48d8174afad02294ee08bb5ef`; Track-4 coroutine-integration rotation — the fixed point MOVED to `18e0de5cf71f4fe0fbf5c560ab24e624`).
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (the 9 std `.zig` in the current v20
...
`6ef08661`). zig0 is retired; the seed model (`scripts/seed/build_from_seed.sh`)
