...
Current seed is **seed v9** (archive md5 `7c1421f6312b59c4c449dcf336e32694`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`4da59bb11270e3c85638bcbb120afc2d`), `gen/` (its self-emission C89 module set —
42 `.c` + 43 `.h`, including `zig_special_types.h`; the emitted runtime/support
sources are NOT in `gen/`), top-level `c_exit.c`, `runtime/` (the canonical 5:
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `4da59bb11270e3c85638bcbb120afc2d` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=4da59bb11270e3c85638bcbb120afc2d` to gate on it explicitly.
...
Binary md5 MUST equal `4da59bb1…`.
...
|---|---|---|
| `examples/z98/mud_server/main.zig` | `68eee54c948bb7c8a850f106e14a36ea` |
| `examples/z98/game_of_life/main.zig` | `2cf07dea247f3bf5e2b22c9532e89dca` |
| `examples/z98/lisp_interpreter_curr/main.zig` | `f13bd982758c8433908c5b5a4e23ebb2` |
| `examples/z98/json_parser/main.zig` | `f61bccfdc121d61844c875cf4d5cc4a8` |
