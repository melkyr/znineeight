...
Current seed is **seed v62** (archive md5 `e083175349cef5e1369d961aa0795837`; v62 rotation — Task B5: the `typeRegistryIsAssignable` EU→EU branch now requires exact payload TypeId equality, so runtime payload-differing error-union coercions clean-reject `error[3000]`; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `31f61d87…` → `6322cd4f916a7cc47c883b22f1f44905` (two-hop closure hop1==hop2)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`6322cd4f916a7cc47c883b22f1f44905`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v62 archive
