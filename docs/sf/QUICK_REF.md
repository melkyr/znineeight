...
- **[updated: 2026-08-14 — F-MIGRATE] examples/repros now use bare `@import("std")`**, resolved
  ...
  `mkdir -p <exe_dir>/lib && cp sf/src/std.zig sf/src/std_io.zig sf/src/std_arena.zig sf/src/std_net.zig sf/src/std_str.zig sf/src/std_mem.zig sf/src/std_math.zig <exe_dir>/lib/`
...
|---|---|---|
| `examples/z98/mud_server/main.zig` | `80b5ba38958282a83f2c38caae4b2ac4` |
| `examples/z98/game_of_life/main.zig` | `c50f983b86f5bccbfe3b809cddb57e6c` |
| `examples/z98/lisp_interpreter_curr/main.zig` | `d3f22d5d3c5f68eba20a0627ce5348ab` |
| `examples/z98/json_parser/main.zig` | `e18477a3f7cc1c235e927f5748c4b364` |
