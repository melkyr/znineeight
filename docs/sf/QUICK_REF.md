...
### Corpus gate (287 dirs in `repro/mi_matrix/*/`, all with `main.zig`)  — classify by gcc EXIT CODE  [updated: 2026-08-20 — widthbits-overflow GATE closeout]
...
| Entry Path | Reference md5 | [updated: 2026-08-20 — json row re-baselined to `9720478c…` (voiddecl-family AMENDMENT 3, F1 front-resolution); lisp row is repo-root-CWD `88dcb7f9…`] |
|---|---|---|
