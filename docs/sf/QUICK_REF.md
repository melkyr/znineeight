...
Current seed is **seed v47** (archive md5 `cccc81768445f05b68bea8d3bb780961`; v47 rotation — Task 11D fix round 1: honor declared float width + operand signedness in float folds; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `ea159fc2…` → `109628afa625baca56c2d4b340a802b0`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`109628afa625baca56c2d4b340a802b0`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v47 archive
...
`lib/`, and the rotated **v47** archive carries all 29. The Plan D closeout lands
...
`repro/mi_matrix/EXPECTED_FAIL.md` v167.
The archived binary and the self-emission fixed point
`109628afa625baca56c2d4b340a802b0` are the SAME compiler state (the v47
provenance entry in `release/seed/CHANGELOG.md` records HEAD `c21f1ff0`). The
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `109628afa625baca56c2d4b340a802b0` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=109628afa625baca56c2d4b340a802b0` to gate on it explicitly.
...
Binary md5 MUST equal `109628afa625baca56c2d4b340a802b0`.
