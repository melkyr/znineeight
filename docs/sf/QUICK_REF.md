...
Current seed is **seed v22** (archive md5 `d98a1ef0e5469aad63ef6a9091fe3dcd`; Track-4 Task-8-F rotation after the suspending-`export fn` synthesized driver landed, moving the fixed point to `9b3075b105ff544f3541d5a621d00d40`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`9b3075b105ff544f3541d5a621d00d40`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (the 9 std `.zig` in the current v22
...
`9b3075b105ff544f3541d5a621d00d40` are the SAME compiler state (HEAD
`66446667`). zig0 is retired; the seed model (`scripts/seed/build_from_seed.sh`)
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `9b3075b105ff544f3541d5a621d00d40` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=9b3075b105ff544f3541d5a621d00d40` to gate on it explicitly.
...
Binary md5 MUST equal `9b3075b105ff544f3541d5a621d00d40`.
