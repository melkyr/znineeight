...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `c8f1a76a97e0fe385faf757d5c4015ba` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=c8f1a76a97e0fe385faf757d5c4015ba` to gate on it explicitly.
...
Binary md5 MUST equal `c8f1a76a97e0fe385faf757d5c4015ba`.
