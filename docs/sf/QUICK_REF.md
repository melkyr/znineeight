...
Current seed is **seed v48** (archive md5 `e30fbafb93b1253ad007c536883030b6`; v48 rotation — Task 11D fix round 2: unwrap parens in float-fold operand signedness; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `109628afa6…` → `0b717b37c412ce5cd6abd87eeb6a36d8`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`0b717b37c412ce5cd6abd87eeb6a36d8`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v48 archive
...
`lib/`, and the rotated **v48** archive carries all 29. The Plan D closeout lands
...
`repro/mi_matrix/EXPECTED_FAIL.md` v168.
The archived binary and the self-emission fixed point
`0b717b37c412ce5cd6abd87eeb6a36d8` are the SAME compiler state (the v48
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `0b717b37c412ce5cd6abd87eeb6a36d8` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=0b717b37c412ce5cd6abd87eeb6a36d8` to gate on it explicitly.
...
Binary md5 MUST equal `0b717b37c412ce5cd6abd87eeb6a36d8`.
