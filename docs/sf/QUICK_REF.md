...
Current seed is **seed v49** (archive md5 `77cff5d2cb032526e2cad6e0a4b38b1a`; v49 rotation — Task 11F: fold integer-valued builtins in array-size positions; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `0b717b37…` → `9b292edf64686968c69e0b15f7da762d`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`9b292edf64686968c69e0b15f7da762d`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v49 archive
