...
Current seed is **seed v64** (archive md5 `0abd7af67a38bb26d92953245e32944e`; v64 rotation — Task 5B win32 default-lib-path fix: `sf/src/main.zig:437` `pal.fileExists(lib_path)` → `pal.dirExists(lib_path)` so the `<exe_dir>/lib` default standard-library search dir is found on win32 (msvcrt `fopen` refuses a directory) as well as Linux; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `5d792f50cea61b9ef09fbd353c4557b0` → `17a476d2543c2ca9dcf0d7e7cb09ba01` (two-hop closure hop1==hop2)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`17a476d2543c2ca9dcf0d7e7cb09ba01`), `gen/` (its self-emission C89 module set —
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `17a476d2543c2ca9dcf0d7e7cb09ba01` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=17a476d2543c2ca9dcf0d7e7cb09ba01` to gate on it explicitly.
...
Binary md5 MUST equal `17a476d2543c2ca9dcf0d7e7cb09ba01`.
