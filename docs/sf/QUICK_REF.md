...
Current seed is **seed v25** (archive md5 `573f0221706e150e034830a51be6aa6c`; Track-4 Task 9-P-F `perm` source-text release (read-per-module into a reset `source` arena + diagnostics fault-in), moving the fixed point to `ba95dd0a698b2f4b72b99953dc72cad5`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`ba95dd0a698b2f4b72b99953dc72cad5`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (the 9 std `.zig` in the current v25
...
`ba95dd0a698b2f4b72b99953dc72cad5` are the SAME compiler state (HEAD
`dc181cf0`). zig0 is retired; the seed model (`scripts/seed/build_from_seed.sh`)
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `ba95dd0a698b2f4b72b99953dc72cad5` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=ba95dd0a698b2f4b72b99953dc72cad5` to gate on it explicitly.
...
Binary md5 MUST equal `ba95dd0a698b2f4b72b99953dc72cad5`.
