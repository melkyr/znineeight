...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `efa91f8d7c000df51d5547b2628f6e9f` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=efa91f8d7c000df51d5547b2628f6e9f` to gate on it explicitly.
...
Binary md5 MUST equal `efa91f8d7c000df51d5547b2628f6e9f`.
