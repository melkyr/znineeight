...
Current seed is **seed v21** (archive md5 `0d4bbc0c477e841e8e983f8cf23e6326`; Track-4 re-rotation after the `addTask` `cancel_requested` fix — a `std_async`-only change, so the fixed point is UNMOVED at `18e0de5cf71f4fe0fbf5c560ab24e624`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`18e0de5cf71f4fe0fbf5c560ab24e624`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (the 9 std `.zig` in the current v21
...
`18e0de5cf71f4fe0fbf5c560ab24e624` are the SAME compiler state (HEAD
`17422544`). zig0 is retired; the seed model (`scripts/seed/build_from_seed.sh`)
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `18e0de5cf71f4fe0fbf5c560ab24e624` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=18e0de5cf71f4fe0fbf5c560ab24e624` to gate on it explicitly.
...
Binary md5 MUST equal `18e0de5cf71f4fe0fbf5c560ab24e624`.
