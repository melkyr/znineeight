...
Current seed is **seed v57** (archive md5 `60c9ac10bd4382b6a25d7ef64daf2191`; v57 rotation — Task 11S (AMENDMENT 14, D1/D2): clean-reject the invalid-Zig array-size `@intCast` range, `[*]T .len`, and `comptime_eval` `@intCast` masking cases with `error[3000]`; supersedes the INTWIDTH `@intCast` truncate/mask semantics; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `13434b4f…` → `5106cc8709c026c60eea113677a3fa5d` (two-hop closure hop1==hop2)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`5106cc8709c026c60eea113677a3fa5d`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v57 archive
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `5106cc8709c026c60eea113677a3fa5d` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=5106cc8709c026c60eea113677a3fa5d` to gate on it explicitly.
...
Binary md5 MUST equal `5106cc8709c026c60eea113677a3fa5d`.
