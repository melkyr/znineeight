...
Current seed is **seed v45** (archive md5 `444f0d997867d3ff97d34d45d9720636`; v45 rotation — Task 10F dynamic error-union-return `errdefer` lowering fix; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `27e61065…` → `ff54332e2d4418eb663f225bbad6d9c7`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`ff54332e2d4418eb663f225bbad6d9c7`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v45 archive
...
`lib/`, and the rotated **v44** archive carries all 29. The Plan D closeout lands
...
`repro/mi_matrix/EXPECTED_FAIL.md` v165.
The archived binary and the self-emission fixed point
`ff54332e2d4418eb663f225bbad6d9c7` are the SAME compiler state (the v45
provenance entry in `release/seed/CHANGELOG.md` records HEAD `cf717d7c`). The
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `ff54332e2d4418eb663f225bbad6d9c7` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=ff54332e2d4418eb663f225bbad6d9c7` to gate on it explicitly.
...
Binary md5 MUST equal `ff54332e2d4418eb663f225bbad6d9c7`.
