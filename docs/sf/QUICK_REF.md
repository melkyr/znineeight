...
Current seed is **seed v52** (archive md5 `b47270f17c7725d02bb0ab405dbe3377`; v52 rotation — Task 11N fix round 1: gate the array-field `.len` fold on the `len` field name; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `6cbb5244…` → `0080736e9637b6993e7539f755f351ea` (two-hop closure hop1==hop2)).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`0080736e9637b6993e7539f755f351ea`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v52 archive
