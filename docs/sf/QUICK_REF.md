...
Current seed is **seed v26** (archive md5 `fbd6a84da8afe1e5a9e31210b4b28cc6`; Track-4 Task 9-Q-F fault-arena lazy-init (defer the first fault-in `growableSandInit` + 4096 B carve), moving the fixed point to `f03d8485f563990367faec4b7d57b5b1`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`f03d8485f563990367faec4b7d57b5b1`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (the 9 std `.zig` in the current v26
...
`f03d8485f563990367faec4b7d57b5b1` are the SAME compiler state (HEAD
`e3e58d7b`). zig0 is retired; the seed model (`scripts/seed/build_from_seed.sh`)
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `f03d8485f563990367faec4b7d57b5b1` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=f03d8485f563990367faec4b7d57b5b1` to gate on it explicitly.
...
Binary md5 MUST equal `f03d8485f563990367faec4b7d57b5b1`.
