...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `4b8a6364ef47e8ebdfc5e4506b7cff02` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=4b8a6364ef47e8ebdfc5e4506b7cff02` to gate on it explicitly.
...
Binary md5 MUST equal `4b8a6364ef47e8ebdfc5e4506b7cff02`.
