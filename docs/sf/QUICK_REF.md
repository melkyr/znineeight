...
Current seed is **seed v46** (archive md5 `0db592d0d00e010a6296674e1e2fd9ce`; v46 rotation — Task 11D `@floatCast`/`@intToFloat` comptime constant folding; the archive `lib/` payload stays all 29 std `.zig`; the fixed point **MOVED** `ff54332e…` → `ea159fc2f14af88b3d450f3ca70eca17`).
Top-level `zig1-seed/`: `zig1` (reference binary md5
`ea159fc2f14af88b3d450f3ca70eca17`), `gen/` (its self-emission C89 module set —
...
`zig_pal.c` — NO `net_prelude.h`), `lib/` (all 29 std `.zig` the v46 archive
...
`lib/`, and the rotated **v46** archive carries all 29. The Plan D closeout lands
...
`repro/mi_matrix/EXPECTED_FAIL.md` v166.
The archived binary and the self-emission fixed point
`ea159fc2f14af88b3d450f3ca70eca17` are the SAME compiler state (the v46
provenance entry in `release/seed/CHANGELOG.md` records HEAD `cc955a69`). The
...
- GATE: `=== [seed] Done: <out_dir> ===`; result `<out_dir>/zig1_5_clean` md5 MUST equal the recorded
  fixed point `ea159fc2f14af88b3d450f3ca70eca17` (hop1 == hop2 closure). Set
  `FIXED_POINT_MD5=ea159fc2f14af88b3d450f3ca70eca17` to gate on it explicitly.
...
Binary md5 MUST equal `ea159fc2f14af88b3d450f3ca70eca17`.
