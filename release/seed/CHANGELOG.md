...
| date | 2026-09-22 |
| HEAD | `6584be65` |
| seed binary md5 | `b32805918b124d8251af42a6b12656c0` |
| self-emission C | 45 `.c` + 46 `.h` (9137164 bytes) |
| fixed point | `b32805918b124d8251af42a6b12656c0` |
| archive md5 | `f77bd05b7b2bfc5b1d2ac76843f5afbb` |

Provenance note: the archived binary (md5 b32805918b124d8251af42a6b12656c0) was captured by
scripts/seed/archive_seed.sh at HEAD 6584be65; gcc of the archive's self-emission
C reproduces the self-emission fixed point `b32805918b124d8251af42a6b12656c0` — both are the same
compiler state at HEAD 6584be65. The compiler self-build uses `-ffast` (user
