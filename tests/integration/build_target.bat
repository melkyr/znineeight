...
gcc -std=c89 -m32 -mconsole -static-libgcc -pedantic -Wall -O2 -I. -Isrc/include -c nested_expr.c -o nested_expr.o
gcc -m32 -mconsole -static-libgcc -o app.exe zig_runtime.o builtin.o nested_expr.o
