...
TEST_FUNC(Task225_2_BracelessIfExpr) {
    ...
    bool found_v1 = generated_c.find("__return_val = 1;") != std::string::npos;
    bool found_v2 = generated_c.find("__return_val = 2;") != std::string::npos;
    bool found_tmp = (generated_c.find("__tmp_if") != std::string::npos) &&
                    (generated_c.find("return __return_val;") != std::string::npos || generated_c.find("return __tmp_if") != std::string::npos);
