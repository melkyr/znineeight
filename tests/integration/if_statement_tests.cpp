 ...
 * @brief Integration tests for Zig if statements in the Z98 compiler.
 */
...
TEST_FUNC(IfStatementIntegration_BoolCondition) {
    const char* source =
        ...
        "    if (b) { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int b) { if (b) { } }");
}
...
TEST_FUNC(IfStatementIntegration_IntCondition) {
    const char* source =
        ...
        "    if (x) { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int x) { if (x) { } }");
}
...
TEST_FUNC(IfStatementIntegration_PointerCondition) {
    const char* source =
        ...
        "    if (ptr) { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int* ptr) { if (ptr) { } }");
}
...
TEST_FUNC(IfStatementIntegration_IfElse) {
    const char* source =
        ...
        "    }\n"
        "}";
    return run_if_stmt_test(source, "foo", "int zF_0_foo(int b) { if (b) { return 1; } else { return 0; } }");
}
...
TEST_FUNC(IfStatementIntegration_ElseIfChain) {
    ...
    return run_if_stmt_test(source, "foo", "int zF_0_foo(int x) { if (x < 0) { return -1; } else if (x == 0) { return 0; } else { return 1; } }");
}
...
TEST_FUNC(IfStatementIntegration_NestedIf) {
    const char* source =
        ...
        "    }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int a, int b) { if (a) { if (b) { return; } } }");
}
...
TEST_FUNC(IfStatementIntegration_LogicalAnd) {
    const char* source =
        ...
        "    if (a and b) { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int a, int b) { if (a && b) { } }");
}
...
TEST_FUNC(IfStatementIntegration_LogicalNot) {
    const char* source =
        ...
        "    if (!a) { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int a) { if (!a) { } }");
}
...
TEST_FUNC(IfStatementIntegration_EmptyBlocks) {
    const char* source =
        ...
        "    if (b) { } else { }\n"
        "}";
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int b) { if (b) { } else { } }");
}
...
TEST_FUNC(IfStatementIntegration_ReturnFromBranches) {
    const char* source =
        ...
        "    return 0;\n"
        "}";
    return run_if_stmt_test(source, "foo", "int zF_0_foo(int x) { if (x > 10) { return 1; } return 0; }");
}
...
TEST_FUNC(IfStatementIntegration_AllowBracelessIf) {
    ...
    return run_if_stmt_test(source, "foo", "void zF_0_foo(int b) { if (b) { return; } }");
}
