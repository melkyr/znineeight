...
TEST_FUNC(Codegen_Global_ConstPointer) {
    return run_global_codegen_test("pub var x: *const i32;", "int const* zV_0_x;");
}
...
TEST_FUNC(Codegen_Global_PointerToGlobal) {
    return run_global_codegen_test("var x: i32 = 0; pub var p: *i32 = &x;", "int* zV_1_p = &zV_0_x;");
}
...
TEST_FUNC(Codegen_Global_Enum) {
    ...
    return run_global_codegen_test("const Color = enum { Red, Green }; pub var c: Color = Color.Red;", "enum zS_0_Color zV_2_c = zS_0_Color_Red;");
}

TEST_FUNC(Codegen_Global_Struct) {
    return run_global_codegen_test("const Point = struct { x: i32, y: i32 }; pub var pt: Point = .{ .x = 1, .y = 2 };", "struct zS_0_Point zV_2_pt = {1, 2};");
}
