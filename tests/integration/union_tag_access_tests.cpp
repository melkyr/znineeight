...
TEST_FUNC(UnionTagAccess_Basic) {
    ...
    if (!unit.validateVariableEmission("tag", "enum zE_1_Value_Tag zV_3_tag = zE_1_Value_Tag_Int;")) {
        return false;
    }
...
TEST_FUNC(UnionTagAccess_Imported) {
    ...
    if (!unit.validateVariableEmission("t", "enum zE_2_JsonValue_Tag zV_4_t = zE_2_JsonValue_Tag_Null;")) {
        return false;
    }
