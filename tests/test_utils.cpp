...
static bool expect_abort(void (*test_func)()) {
    ...
    if (pid == 0) { // Child process
        ...
        */
        ...
        // We consider it a success if the process was terminated by a signal (likely SIGABRT)
        // or if it exited with a non-zero status that our internal handlers set.
