...
int main(int argc, char* argv[]) {
    ...
    bool (*tests[])() = {
        ...
        */
        ...
        test_TypeChecker_ConstAssignment,
        test_TypeChecker_ConstAssignmentUndeclared,
        test_TypeChecker_NullLiteral_ValidAssignment,
        test_TypeChecker_NullLiteral_InvalidAssignment,
    };
