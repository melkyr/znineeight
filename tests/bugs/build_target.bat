...
cl.exe /nologo /W3 /I. /Isrc/include /D_WIN32_WINDOWS=0x0410 /DWINVER=0x0410 /D_WIN32_WINNT=0x0400 /DNTDDI_VERSION=0x04000000 /c multi_module_token.c
cl.exe /nologo /W3 /I. /Isrc/include /D_WIN32_WINDOWS=0x0410 /DWINVER=0x0410 /D_WIN32_WINNT=0x0400 /DNTDDI_VERSION=0x04000000 /c multi_module_main.c
