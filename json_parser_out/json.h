...
enum z_json_JsonValueTag {
    ...
    z_json_JsonValueTag_BoolValue = 1,
    z_json_JsonValueTag_Number = 2,
    z_json_JsonValueTag_StringValue = 3,
    z_json_JsonValueTag_ArrayValue = 4,
    z_json_JsonValueTag_ObjectValue = 5
};
...
union z_json_JsonData {
    int BoolValue;
    double Number;
    Slice_u8 StringValue;
    Slice_z_json_JsonValue ArrayValue;
    Slice_z_json_Property ObjectValue;
};
