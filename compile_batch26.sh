...
FLAGS="-std=c++98 -pedantic -Wall -Wno-error=unused-function -Wno-error=c++11-extensions -Wno-error=unused-variable -DDEBUG -Isrc/include -Itests/integration -Itests/c89_validation"
g++ $FLAGS $BOOTSTRAP_SRCS $TEST_SRCS tests/main_batch26.cpp -o test_runner_batch26
