...
enum z_token_TokenTag {
    z_token_TokenTag_LParen = 0,
    z_token_TokenTag_RParen = 1,
    z_token_TokenTag_Int = 2,
    z_token_TokenTag_Symbol = 3,
    z_token_TokenTag_Eof = 4
};
typedef enum z_token_TokenTag z_token_TokenTag;
...
struct z_token_Token {
    enum z_token_TokenTag tag;
    union z_token_TokenData data;
};
