...
const char* ErrorHandler::getMessage(ErrorCode code) {
    switch (code) {
        ...
        case ERR_RANGE_TOO_LARGE:               return "range too large";
        case ERR_INVALID_RANGE:                 return "invalid range";
        case ERR_NONCONSTANT_RANGE:             return "range bounds must be compile-time constants";
