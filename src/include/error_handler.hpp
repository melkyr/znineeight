...
enum ErrorCode {
    ...
    ERR_CAST_TARGET_NOT_POINTER = 2007,
    ERR_CAST_SOURCE_NOT_POINTER = 2008,
    ERR_SIZE_OF_INCOMPLETE_TYPE = 2009,
    ERR_INT_CAST_OVERFLOW = 2010,
    ERR_FLOAT_CAST_OVERFLOW = 2011,
    ERR_CAST_SOURCE_NOT_INTEGER = 2012,
    ERR_CAST_SOURCE_NOT_FLOAT = 2013,
    ERR_CAST_TARGET_NOT_INTEGER = 2014,
    ERR_CAST_TARGET_NOT_FLOAT = 2015,
    ERR_OFFSETOF_NON_AGGREGATE = 2016,
    ERR_OFFSETOF_FIELD_NOT_FOUND = 2017,
    ERR_OFFSETOF_INCOMPLETE_TYPE = 2018,
    ERR_GLOBAL_VAR_NON_CONSTANT_INIT = 2019,
    ERR_FUNCTION_CANNOT_RETURN_ARRAY = 2020,
    ERR_TRY_ON_NON_ERROR_UNION = 2021,
    ERR_TRY_IN_NON_ERROR_FUNCTION = 2022,
    ERR_CATCH_ON_NON_ERROR_UNION = 2023,
    ERR_CATCH_TYPE_MISMATCH = 2024,
    ERR_TRY_INCOMPATIBLE_ERROR_SETS = 2025,
    ERR_RANGE_TOO_LARGE = 2026,
    ERR_INVALID_RANGE = 2027,
    ERR_NONCONSTANT_RANGE = 2028,
    ERR_DUPLICATE_ELSE = 2029,
    ERR_CASE_TYPE_MISMATCH = 2030,
    ERR_SWITCH_EXPR_NO_ELSE = 2031,
    ERR_EXPECTED_TYPE_FOR_FIELD = 2032,
    ...
    ERR_EXTERN_FN_WITH_BODY = 3006,
    ERR_BREAK_OUTSIDE_LOOP = 3007,
    ERR_CONTINUE_OUTSIDE_LOOP = 3008,
    ERR_UNKNOWN_LABEL = 3009,
    ERR_DUPLICATE_LABEL = 3010,
    ERR_RETURN_INSIDE_DEFER = 3011,
    ERR_BREAK_INSIDE_DEFER = 3012,
    ERR_CONTINUE_INSIDE_DEFER = 3013,
    ERR_TOO_MANY_DEFERS = 3014,

    // Operational Errors (4000-4999)
    ERR_INVALID_OPERATION = 4000,
    ERR_INVALID_VOID_POINTER_ARITHMETIC = 4001,
    ERR_DIVISION_BY_ZERO = 4002,
    ERR_POINTER_ARITHMETIC_INVALID_OPERATOR = 4003,
    ERR_POINTER_ARITHMETIC_NON_UNSIGNED = 4004,
    ERR_POINTER_ARITHMETIC_VOID = 4005,
    ERR_POINTER_SUBTRACTION_INCOMPATIBLE = 4006,
    ERR_INVALID_OP_FUNCTION_POINTER = 4007,
    ERR_DEREF_FUNCTION_POINTER = 4008,
    ERR_INDEX_FUNCTION_POINTER = 4009,

    // System Errors (5000-5999)
    ERR_OUT_OF_MEMORY = 5000,
    ERR_INTERNAL_ERROR = 5001,
    ERR_FILE_NOT_FOUND = 5002,
    ERR_CIRCULAR_IMPORT = 5003
};
...
enum InfoCode {
    ...
    INFO_INDIRECT_CALL_ADVICE = 9002
};
