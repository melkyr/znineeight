...
public:
     ...
     */
    void addInstantiation(const char* name, const char* mangled_name, DynamicArray<GenericParamInfo>* params, DynamicArray<Type*>* arg_types, int count, SourceLocation loc, const char* module, bool is_explicit, u32 param_hash);
