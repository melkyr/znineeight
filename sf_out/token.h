...
#ifndef ZIG_ENUM_zS_89baa7c0_e25ebdcf_SyncContext
#define ZIG_ENUM_zS_89baa7c0_e25ebdcf_SyncContext
enum zS_89baa7c0_e25ebdcf_SyncContext {
    zS_89baa7c0_e25ebdcf_SyncContext_stmt_list = 0,
    zS_89baa7c0_e25ebdcf_SyncContext_expression = 1,
    zS_89baa7c0_e25ebdcf_SyncContext_switch_prong = 2,
    zS_89baa7c0_e25ebdcf_SyncContext_fn_body = 3,
    zS_89baa7c0_e25ebdcf_SyncContext_module_root = 4
};
typedef enum zS_89baa7c0_e25ebdcf_SyncContext zS_89baa7c0_e25ebdcf_SyncContext;

#endif /* ZIG_ENUM_zS_89baa7c0_e25ebdcf_SyncContext */
...
#ifndef ZIG_OPTIONAL_Optional_zS_89baa7c0_facdb0ca_TokenKind
#define ZIG_OPTIONAL_Optional_zS_89baa7c0_facdb0ca_TokenKind
struct Optional_zS_89baa7c0_facdb0ca_TokenKind {
    enum zS_89baa7c0_facdb0ca_TokenKind value;
    int has_value;
};
typedef struct Optional_zS_89baa7c0_facdb0ca_TokenKind Optional_zS_89baa7c0_facdb0ca_TokenKind;
#endif

#ifndef ZIG_STRUCT_zS_89baa7c0_28f04bce_KeywordEntry
#define ZIG_STRUCT_zS_89baa7c0_28f04bce_KeywordEntry
struct zS_89baa7c0_28f04bce_KeywordEntry {
    Slice_u8 name;
    enum zS_89baa7c0_facdb0ca_TokenKind kind;
};

#endif /* ZIG_STRUCT_zS_89baa7c0_28f04bce_KeywordEntry */
...
extern Slice_zS_89baa7c0_28f04bce_KeywordEntry zV_89baa7c0_8c1e49a4_keyword_table;
extern usize zV_89baa7c0_5ad3148f_keyword_count;

void zF_89baa7c0_aa606f4f_initKeywordTable(struct zS_26b5a9a4_43f95de6_Sand*);
Optional_zS_89baa7c0_facdb0ca_TokenKind zF_89baa7c0_3b776c71_lookupKeyword(Slice_u8);
