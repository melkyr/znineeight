...
pub fn builtin_cons(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 2) return error.WrongArity;
    return try value_mod.alloc_cons(args[0], args[1], arena);
}

pub fn builtin_car(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
...
pub fn builtin_cdr(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 1) return error.WrongArity;
    if (args[0].tag == value_mod.ValueTag.Cons) {
...
pub fn builtin_add(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    var sum: i64 = 0;
    for (args) |arg| {
...
pub fn builtin_sub(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
...
pub fn builtin_mul(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    var res: i64 = 1;
    for (args) |arg| {
        if (arg.tag == value_mod.ValueTag.Int) {
            res *= arg.data.Int;
...
pub fn builtin_div(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len == 0) return error.WrongArity;
    var res: i64 = 0;
    if (args[0].tag == value_mod.ValueTag.Int) {
        res = args[0].data.Int;
...
pub fn builtin_eq(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 2) return error.WrongArity;
    const a = args[0];
    const b = args[1];
    var res = false;
...
pub fn builtin_is_nil(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 1) return error.WrongArity;
    var res = false;
...
pub fn builtin_lt(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 2) return error.WrongArity;
...
pub fn builtin_gt(args: []*value_mod.Value, arena: *value_mod.sand_mod.LispSand) !*value_mod.Value {
    if (args.len != 2) return error.WrongArity;
    if (args[0].tag == value_mod.ValueTag.Int and args[1].tag == value_mod.ValueTag.Int) {
        return try value_mod.alloc_bool(args[0].data.Int > args[1].data.Int, arena);
    }
