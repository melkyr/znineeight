// volatile_drop_manyptr_xmod — GREEN guard (A10F qualifier safety). An
// implicit `*volatile u32 -> [*]u32` drop must be rejected (the source's
// volatile qualifier may not be silently discarded).
//
